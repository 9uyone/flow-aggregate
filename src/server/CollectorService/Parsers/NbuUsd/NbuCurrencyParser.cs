...
[ParserParameter("valcode", "Requested currency. By default is USD.", isRequired: false, allowCustomValues: false)]
[ParserParameter("date", "Requested date in format YYYYMMDD. By default is current.", isRequired: false, allowCustomValues: true)]
